<!-- 树形选择框 -->
<template>
  <el-select ref="select" :value="value" placeholder="请选择" clearable style="width: 100%;" @visible-change="visibleChange" @clear="clear">
...
export default {
  ...
  methods: {
    ...
    visibleChange(e) {
      if (e) {
        const selectDom = document.querySelector('.is-current')
        setTimeout(() => {
