<template>
  <div class="bottom-table common-shadow">
    ...
    <dialogManaulCheck :show.sync="dialogVisibleManual" type="MAINTAIN" @reload="$refs.pageTable.reload()" />
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    query(param = {}) {
      return this.$http.getParam('/patrol/getAdminPatrolRecordVoIPageByMAINTAIN', { ...param, ...this.queryForm })
    },
    download(item) {
